...
/**
 * Operations on `/v1/refunds`.
 */
final class RefundService extends AbstractService
{
    private const BASE = '/v1/refunds';
     ...
     * @param array<string,mixed>|RequestOptions|null $opts
     */
    public function retrieve(string $id, array $params = [], array|RequestOptions|null $opts = null): Refund
    {
        /** @var Refund $obj */
     ...
     * @param array<string,mixed>|RequestOptions|null $opts
     */
    public function create(array $params, array|RequestOptions|null $opts = null): Refund
    {
        /** @var Refund $obj */
